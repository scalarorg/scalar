...
use scalar_types::base_types::{ObjectDigest, SequenceNumber};
use scalar_types::base_types::{ObjectID, SuiAddress};
use scalar_types::gas_coin::GasCoin;
use scalar_types::object::{MoveObject, Owner};
use scalar_types::{parse_sui_struct_tag, MOVE_STDLIB_ADDRESS, SUI_FRAMEWORK_ADDRESS};

use crate::ObjectChange;
// use crate::{SuiMoveStruct, SuiMoveValue};

/*
 * 23-11-07 TaiVV
 * Move to scalar-move/src/move_json_rpc_types/unit_tests/rpc_types_tests.rs
 */
// #[test]
