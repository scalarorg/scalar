...
use sui_config::node::{
    default_consensus_rpc_address, default_enable_index_processing,
    default_end_of_epoch_broadcast_channel_capacity, AuthorityKeyPairWithPath,
    AuthorityStorePruningConfig, DBCheckpointConfig, ExpensiveSafetyCheckConfig, Genesis,
...
impl ValidatorConfigBuilder {
    ...
    pub fn build(
        ...
        NodeConfig {
            ...
            consensus_rpc_address: default_consensus_rpc_address(),
        }
    }
