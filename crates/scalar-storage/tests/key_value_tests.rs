...
use scalar_types::base_types::{random_object_ref, ExecutionDigests, ObjectID, VersionNumber};
...
mod simtests {
    ...
    use scalar_storage::http_key_value_store::*;
