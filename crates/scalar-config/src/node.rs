...
use scalar_types::crypto::NetworkKeyPair;
use scalar_types::crypto::SuiKeyPair;
use scalar_types::crypto::{get_key_pair_from_rng, AccountKeyPair, AuthorityKeyPair};
...
pub const DEFAULT_VALIDATOR_GAS_PRICE: u64 = scalar_types::transaction::DEFAULT_VALIDATOR_GAS_PRICE;
