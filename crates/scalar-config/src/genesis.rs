...
use scalar_types::clock::Clock;
use scalar_types::committee::CommitteeWithNetworkMetadata;
use scalar_types::crypto::DefaultHash;
...
impl Genesis {
    ...
    pub fn clock(&self) -> Clock {
        let clock = self
            .objects()
            .iter()
            .find(|o| o.id() == scalar_types::SUI_CLOCK_OBJECT_ID)
...
impl GenesisCeremonyParameters {
    ...
    fn default_initial_stake_subsidy_distribution_amount() -> u64 {
        // 1M Sui
        1_000_000 * scalar_types::gas_coin::MIST_PER_SUI
    }
    ...
    pub fn to_genesis_chain_parameters(&self) -> GenesisChainParameters {
        GenesisChainParameters {
            ...
            max_validator_count: scalar_types::governance::MAX_VALIDATOR_COUNT,
            min_validator_joining_stake: scalar_types::governance::MIN_VALIDATOR_JOINING_STAKE_MIST,
            validator_low_stake_threshold:
                scalar_types::governance::VALIDATOR_LOW_STAKE_THRESHOLD_MIST,
            validator_very_low_stake_threshold:
                scalar_types::governance::VALIDATOR_VERY_LOW_STAKE_THRESHOLD_MIST,
            validator_low_stake_grace_period:
                scalar_types::governance::VALIDATOR_LOW_STAKE_GRACE_PERIOD,
        }
    }
}
...
impl TokenDistributionSchedule {
    ...
    >(
        ...
        let minimum_required_stake = scalar_types::governance::VALIDATOR_LOW_STAKE_THRESHOLD_MIST;
    ...
    pub fn new_for_validators_with_default_allocation<I: IntoIterator<Item = SuiAddress>>(
        ...
        let default_allocation = scalar_types::governance::VALIDATOR_LOW_STAKE_THRESHOLD_MIST;
