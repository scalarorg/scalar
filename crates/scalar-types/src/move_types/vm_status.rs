...
/*
 * 2023-11-03 TaiVV
 * Copy Type struct from external-crates/move/move-core/types/src/vm_status.rs
 * Dinh nghia cac struct luu trang thai cua Move VM
 * Todo: Move logic cua vm sang component rieng support Move language
 * Tags: SCALAR_MOVE_LANGUAGE, SCALAR_MOVE_VM
 */
