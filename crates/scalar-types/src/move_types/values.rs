...
/*
 * 2023-11-03 TaiVV
 * Copy Type struct from external-crates/move/move-command-line-common/src/values.rs
 * Tags: SCALAR_MOVE_LANGUAGE, SCALAR_MOVE_VALUES
 */
