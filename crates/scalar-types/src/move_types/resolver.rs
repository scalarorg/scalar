...
/*
 * 2023-11-03
 * TaiVV copy and modify from external-crates/move/move-core/types/resolver.rs
 * Định nghĩa các trait để resolving Move modules và resource từ storage
 * Tags: SCALAR_MOVE_LANGUAGE, SCALAR_RESOLVER
 */
