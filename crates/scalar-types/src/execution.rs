...
/*
 * 2023-11-02 TaiVV
 * copy and modify from sui-types/src/execution.rs
...
/*
 * 2023-11-02 TaiVV
 * Chứa thông tin của một lần execute trong move evm:
 * Các object tạo ra, objects được modify, các object bị xoá, các event tạo ra trong quá trình execute
 * Todo:
 *      đưa ra tầng logic, mỗi logic chứa một cấu trúc riêng
 *      Xây dựng cấu trúc tương tự cho EVM
 * Tags: SCALAR_EXECUTION, SCALAR_EXECUTION_RESULT, SCALAR_EXECUTION_EVM, SCALAR_EXECUTION_RESULT_EVM
 */
