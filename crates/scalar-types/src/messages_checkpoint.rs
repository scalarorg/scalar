...
/*
 * 2023-11-02 TaiVV
 * copy and modify from sui-types/src/messages_checkpoint.rs
 * Dinh nghia cac struct phuc vu muc dich giam sat cac thong so cua he thong (CheckPoint)
 * Tags: SCALAR_CHECKPOINT, SCALAR_MESSAGE
 */
