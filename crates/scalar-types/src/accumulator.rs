...
/*
 * 2023-11-02 TaiVV
 * copy and modify from sui-types/src/accumulator.rs
 * Dinh nghia kieu Accumulator tu fastcrypto::hash::EllipticCurveMultisetHash
 * Hash 1 set du lieu (khong phan biet thu tu)
 * Tags: SCALAR_HASH, HASH_SET
 */
