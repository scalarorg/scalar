...
/*
 * 2023-11-02 TaiVV
 * copy and modify from sui-types/src/unit-test/base_types_tests.rs
 * Tags: SCALAR_TYPES, SCALAR_UNIT_TEST
 */
...
/*
 * 2023-11-02 TaiVV
 * dua code lien quan toi Move language ra cac package rieng
 * Tags: SCALAR_TYPES, SCALAR_UNIT_TEST
 */
