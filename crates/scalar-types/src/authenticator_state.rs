...
/*
 * 2023-11-02 TaiVV
 * copy and modify from sui-types/src/authenticator_state.rs
 * Luu thong tin Json Web Key (Jwk) dai dien cho JWT su dung trong viec authentication bang OIDC (OpenID Connect) provider
 * Tags: SCALAR_AUTHENTICATOR
 */
...
/*
 * 2023-11-03 TaiVV
 * lay du lieu tu store va desirialize thanh object AuthenticatorStateInner
