...
/*
 * 2023-11-02 TaiVV
 * copy and modify from sui-types/src/zk_login_authenticator.rs
 * Cho phep login tu cac he thong Oauth nhu google. github, facbook
 * Todo: Tim hieu them ve zk Login
 * Tags: SCALAR_ZK_LOGIN
 */
