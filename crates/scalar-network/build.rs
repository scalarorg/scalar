    ...
    let validator_service = Service::builder()
        ...
        .method(
            Method::builder()
                ...
                .input_type("scalar_types::transaction::Transaction")
                .output_type("scalar_types::messages_grpc::HandleTransactionResponse")
        ...
        .method(
            Method::builder()
                ...
                .input_type("scalar_types::transaction::CertifiedTransaction")
                .output_type("scalar_types::messages_grpc::HandleCertificateResponse")
                .codec_path(codec_path)
                .build(),
        )
        .method(
            Method::builder()
                ...
                .input_type("scalar_types::transaction::CertifiedTransaction")
                .output_type("scalar_types::messages_grpc::HandleCertificateResponseV2")
                .codec_path(codec_path)
                .build(),
        )
        .method(
            Method::builder()
                ...
                .input_type("scalar_types::transaction::CertifiedTransaction")
                .output_type("scalar_types::messages_grpc::SubmitCertificateResponse")
                .codec_path(codec_path)
                .build(),
        )
        .method(
            Method::builder()
                ...
                .input_type("scalar_types::messages_grpc::ObjectInfoRequest")
                .output_type("scalar_types::messages_grpc::ObjectInfoResponse")
                .codec_path(codec_path)
                .build(),
        )
        .method(
            Method::builder()
                ...
                .input_type("scalar_types::messages_grpc::TransactionInfoRequest")
                .output_type("scalar_types::messages_grpc::TransactionInfoResponse")
                .codec_path(codec_path)
                .build(),
        )
        .method(
            Method::builder()
                ...
                .input_type("scalar_types::messages_checkpoint::CheckpointRequest")
                .output_type("scalar_types::messages_checkpoint::CheckpointResponse")
                .codec_path(codec_path)
                .build(),
        )
        .method(
            Method::builder()
                ...
                .input_type("scalar_types::messages_grpc::SystemStateRequest")
                .output_type("scalar_types::sui_system_state::SuiSystemState")
                .codec_path(codec_path)
                .build(),
        )
        .build();
    ...
    let state_sync = anemo_build::manual::Service::builder()
        ...
        .method(
            anemo_build::manual::Method::builder()
                ...
                .request_type("scalar_types::messages_checkpoint::CertifiedCheckpointSummary")
                .response_type("()")
                .codec_path(codec_path)
                .build(),
        )
        .method(
            anemo_build::manual::Method::builder()
                ...
                .response_type(
                    "Option<scalar_types::messages_checkpoint::CertifiedCheckpointSummary>",
                )
                .codec_path(codec_path)
                .build(),
        )
        .method(
            anemo_build::manual::Method::builder()
                ...
                .request_type("scalar_types::messages_checkpoint::CheckpointContentsDigest")
                .response_type("Option<scalar_types::messages_checkpoint::FullCheckpointContents>")
                .codec_path(codec_path)
                .build(),
        )
        .method(
