...
use rand::rngs::OsRng;
use scalar_config::genesis::{TokenAllocation, TokenDistributionScheduleBuilder};
use scalar_types::base_types::{AuthorityName, SuiAddress};
use scalar_types::committee::{Committee, ProtocolVersion};
use scalar_types::crypto::{AccountKeyPair, KeypairTraits, PublicKey};
...
#[cfg(test)]
mod tests {
    use scalar_config::node::Genesis;
