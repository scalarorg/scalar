...
use crate::{ConsensusOnNewPayloadError, EthConsensusAdapterEvent};
use futures::{future::Either, FutureExt};
use reth_interfaces::RethResult;
use reth_payload_builder::{error::PayloadBuilderError, PayloadId};
use reth_rpc_types::{
    engine::{
...
pub enum EthConsensusMessage {
    ...
    NewPayload {
        ...
        tx: oneshot::Sender<Result<PayloadStatus, ConsensusOnNewPayloadError>>,
    },
    ...
    /// Add a new listener for [`EthConsensusAdapter`].
    EventListener(UnboundedSender<EthConsensusAdapterEvent>),
}
