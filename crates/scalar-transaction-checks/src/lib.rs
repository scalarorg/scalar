...
mod checked {
    ...
    use scalar_types::error::{UserInputError, UserInputResult};
    ...
    use scalar_types::storage::ReceivedMarkerQuery;
    use scalar_types::storage::{BackingPackageStore, GetSharedLocks};
    ...
    pub fn check_non_system_packages_to_be_published(
        ...
        let mut verifier = scalar_execution::verifier(protocol_config, is_metered, metrics);
