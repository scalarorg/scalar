...
pub type TofndKeygenOutput = anyhow::Result<TofnKeygenOutput>;
/// type for bytes
pub use tofn::sdk::api::BytesVec;

/// KeygenInitSanitized holds all arguments needed by Keygen in the desired form; populated by types::KeygenInit
...
impl Context {
    ...
    pub fn share_counts(&self) -> anyhow::Result<PartyShareCounts> {
