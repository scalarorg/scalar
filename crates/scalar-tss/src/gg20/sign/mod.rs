...
//!
//! Protocol:
//!   1. [self::init] First, the initialization message [narwhal_types::SignInit] is received from the client.
...
impl Gg20Service {
    ...
    pub async fn sign_init(
        ...
        debug!("create in and out channels for each share, and spawn as many threads");
        ...
        for my_tofnd_subindex in 0..my_share_count {
            ...
            let chans = ProtocolCommunication::new(sign_receiver, tx_message_out.clone());
