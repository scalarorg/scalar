...
use crate::eth::StateProviderDatabase;
use reth_primitives::{
...
use revm_primitives::{Address, EnvWithHandlerCfg};
...
impl PendingBlockEnv {
        ...
        Pool: TransactionPool,
    {
        ...
        let parent_beacon_block_root = if origin.is_actual_pending() {
            ...
            //todo!("Remove pending block from consensus component")
        ...
        // todo!("Remove pending block from rpc component");
        ...
        // );
        let balance_increments = HashMap::<Address, u128>::default();
        ...
        let blob_gas_used = if cfg.handler_cfg.spec_id >= SpecId::CANCUN {
...
/*
 * TaiVV
 * Mar 06 Remove pending block from consensus component
 */
